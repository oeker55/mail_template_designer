/**
 * Seeds the Soul Stretch template into the configured backend API.
 *
 * Usage:
 *   node seed-soul-stretch-template.js
 *
 * Optional overrides:
 ...
 *   SCODE=LOCAL_MAGAZA
 *   SUBJECT_ID=44
 *   TITLE="Soul Stretch Yoga Seans Daveti"
 */
...
async function seedTemplate() {
  const templatePath = path.join(__dirname, 'src', 'data', 'soul-stretch-template.json');
